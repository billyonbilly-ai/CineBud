...
**CineBud** is a Telegram bot designed for film and TV buffs who want to stay ahead of the curve. It tracks movie and TV news via the TMDB API and uses Groq AI to deliver updates with the energy and personality of a friend who lives and breathes cinema.
...
- **AI-Powered Notifications:** Instead of robotic alerts, CineBud uses Groq to rewrite raw TMDB data into enthusiastic, friendly messages.
...
- **Groq API Key:** Obtain one from your Groq console (https://console.groq.com/keys).
...
2.  **Environment Variables:** You will be prompted to add your `BOT_TOKEN`, `TMDB_API_KEY`, and `GROQ_API_KEY`.
...
├── notifications/    # Groq AI notification crafting
